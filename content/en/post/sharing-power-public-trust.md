---
title: "Can we build public trust by sharing power? This game could"
seoTitle: "Can we build public trust by sharing power? This game could - The New Global School"
description: "Instead of assuming that power needs to sit at the center of government and at the top of organizations we assume the opposite. We push authority to where the knowledge, expertise and wisdom sits."
slug: "sharing-power-public-trust"
lang: "en"
type: "post"
date: "2019-11-12 19:23:26"
canonical: "https://theglobal.school/sharing-power-public-trust/"
ogTitle: "Sharing power to rebuild public trust"
ogImage: "/media/2019/11/Sharing_power_to_rebuild_public_trust.webp"
hero: "https://media.nesta.org.uk/images/CPI_final_1-page-001.width-1200.jpg"
targetKeyword: "Sharing Power Public Trust"
sourceUrl: "https://theglobal.school/sharing-power-public-trust/"
images: ["https://media.nesta.org.uk/images/CPI_final_1-page-001.width-1200.jpg", "/media/2019/12/THE-GLOBAL-SCHOOL-LEADERS-1-1024x576.webp"]
---
The Centre for Public Impact (CPI) use the mechanics of a card game to explore how the rules of power within government should change. The game contrasts the rules of ‘old’ power – hierarchy, control and targets – with those of ‘new’ power – subsidiarity, relationships, and learning. It draws on [a wider body of work from the CPI](https://resources.centreforpublicimpact.org/production/2019/07/WEB-CPI-Shared-Power-Principle.pdf) which argues that spreading and sharing power as far as possible is essential for the government to remain effective and rebuild public trust. Below is the CPI’s pitch explaining the importance of the ideas and concepts which inform the Shared Power Principle game.

![CPI game final](https://media.nesta.org.uk/images/CPI_final_1-page-001.width-1200.jpg)Shared Power Principle card game illustration by Joe Wilson
...
*If you are interested in playing the actual game, please contact the* [*CPI*](https://www.sharedpowerprinciple.org/)*via their website or find them on Twitter* [@CPI\_foundation](https://twitter.com/CPI_foundation?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor)*. The game’s illustrator is* [*Joe Wilson*](https://www.joe-wilson.com/)*.*
